...
/*получаем почту и название курса*/    
foreach($res as $row) {
$email_course = $row['email'];
$course = $row['name_course'];}

/*если почта в заявках и почта пользователя совпадает*/ 
if($email_course == $email) {print("<p>Ваша заявка на участие в курсе рассматривается</p>"."<p> Выбранный курс - $course</p>"); }
/*иначе*/ 
else{print("<p> У вас нет заявок </p>" ); }
}}}}?></td>
