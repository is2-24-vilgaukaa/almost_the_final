...
<input class="courseInput" id = "user_course" name="user_course" placeholder="Желаемый курс" required pattern="[a-zA-Zа-яА-Я]+"> <br>
<input class="courseInput" id = "user_email" name="user_email" placeholder="Email" required pattern="[a-zA-Zа-яА-Я0-9@_-.]+"> <br>
<input class="courseInput" id = "user_phone" name="user_phone" placeholder="Номер телефона" required pattern="[0-9]+"> <br>
